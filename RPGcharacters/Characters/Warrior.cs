...
public class Warrior : Hero
{
    ...
    public void DisplayStats()
    {
        ...
        Console.Write($"{Level}\n");
        Console.ResetColor();
        Console.WriteLine($"Strength: {MainStat}");
    ...
    public override string ItemEquip(Item item)
    {
        if (typeof(Weapon) == item.GetType())
        {
            ...
            if (weapon.Weapons == WeaponTypes.Axe ||
                weapon.Weapons == WeaponTypes.Hammer ||
        ...
        if (typeof(Armor) == item.GetType())
        {
            ...
            if (armor.Armors == ArmorTypes.Mail ||
                    armor.Armors == ArmorTypes.Plate)
            {
